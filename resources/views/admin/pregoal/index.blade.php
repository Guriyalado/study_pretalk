...
<div class="container-fluid pt-4 px-4">
    ...
    {{-- <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Pregoal</h4>
        </div>--}}
        <div class="col-md-12 align-self-end text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('dashboard') }}">Home</a></li>
                    <li class="breadcrumb-item active">Pregoal</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            <div class="bg-secondary rounded h-100 p-4">
                <div class="card-header modal-header d-flex align-items-center justify-content-between">
                    <h3 class="mb-0">Pregoal</h3>

                    <button type="button" class="btn btn-primary btn-modal waves-effect waves-light"
                        data-href="{{ action('App\Http\Controllers\Admin\Pregoal\PregoalController@create') }}"
                        data-container="">
